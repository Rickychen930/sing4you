    ...
    <header className="glass-effect-strong fixed w-full top-0 left-0 right-0 z-50 border-b border-gold-900/40 transition-all duration-300 overflow-visible">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 overflow-visible" aria-label="Main navigation">
        <div className="flex justify-between items-center h-14 sm:h-16 lg:h-18 xl:h-20">
          ...
          <button
            type="button"
            className="md:hidden p-2.5 -mr-2 min-w-[48px] min-h-[48px] flex items-center justify-center text-gray-200 hover:text-gold-300 transition-colors focus:outline-none focus:ring-2 focus:ring-gold-500 focus:ring-offset-2 focus:ring-offset-jazz-900 rounded-lg"
