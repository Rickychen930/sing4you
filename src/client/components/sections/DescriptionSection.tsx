    ...
    <div className={cn('mt-6 sm:mt-7 lg:mt-8 xl:mt-10 pt-6 sm:pt-7 lg:pt-8 xl:pt-10 border-t-2 border-gold-900/60 sm:border-gold-900/50 hover:border-gold-800/70 transition-colors duration-300 relative group', className)}>
      ...
      <div className="relative">
        ...
        <div className="prose prose-invert max-w-none">
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-200 font-sans whitespace-pre-line leading-relaxed group-hover:text-gray-200/95 transition-colors duration-300 description-section-text">
            {description}
          </p>
        </div>
      </div>
