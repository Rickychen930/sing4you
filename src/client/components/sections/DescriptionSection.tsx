...
export const DescriptionSection: React.FC<DescriptionSectionProps> = memo(({
  ...
  return (
    <div className={cn('mt-6 sm:mt-7 lg:mt-8 xl:mt-10 pt-6 sm:pt-7 lg:pt-8 xl:pt-10 border-t-2 border-gold-900/60 sm:border-gold-900/50 hover:border-gold-800/70 transition-colors duration-300 relative group', className)}>
      <div className="absolute top-0 left-0 w-20 sm:w-28 md:w-36 h-px bg-gradient-to-r from-gold-400/70 via-musical-500/70 to-transparent rounded-full opacity-70" aria-hidden />
      <div className="relative">
        ...
        <div className="prose prose-invert max-w-none">
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-200 whitespace-pre-line leading-relaxed font-sans group-hover:text-gray-100 transition-colors duration-300" style={{ textShadow: '0 1px 3px rgba(0, 0, 0, 0.4)' }}>
            {description}
          </p>
        </div>
      </div>
