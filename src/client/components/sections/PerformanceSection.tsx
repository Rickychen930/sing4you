          ...
          >
            <Card className="flex flex-col" hover>
              <CardBody className="flex-grow">
                ...
                <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-200 font-sans mb-6 sm:mb-7 lg:mb-8 xl:mb-10 whitespace-pre-line leading-relaxed group-hover:text-gray-100 transition-colors duration-300 performance-section-description">{section.description}</p>
