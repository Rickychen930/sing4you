...
export const Button = memo(forwardRef<HTMLButtonElement, ButtonProps>(({
  ...
  const variants = {
    primary: 'bg-gradient-to-r from-gold-600 via-gold-500 to-gold-600 text-white hover:from-gold-500 hover:via-gold-400 hover:to-gold-500 hover:scale-[1.02] shadow-[0_4px_14px_rgba(255,194,51,0.35),0_0_0_1px_rgba(255,194,51,0.2)] hover:shadow-[0_6px_20px_rgba(255,194,51,0.4),0_0_0_1px_rgba(255,194,51,0.25)] before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/20 before:to-transparent before:translate-x-[-200%] hover:before:translate-x-[200%] before:transition-transform before:duration-500 before:ease-in-out',
    secondary: 'bg-gradient-to-r from-jazz-800 via-musical-700 to-jazz-800 text-white hover:from-jazz-700 hover:via-musical-600 hover:to-jazz-700 hover:scale-[1.02] shadow-[0_4px_14px_rgba(168,85,247,0.35),0_0_0_1px_rgba(168,85,247,0.2)] hover:shadow-[0_6px_20px_rgba(168,85,247,0.4),0_0_0_1px_rgba(168,85,247,0.25)] before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/20 before:to-transparent before:translate-x-[-200%] hover:before:translate-x-[200%] before:transition-transform before:duration-500',
    outline: 'border-2 border-gold-500/90 text-gold-300 glass-effect hover:bg-gold-900/40 hover:border-gold-400 hover:text-gold-200 hover:shadow-[0_4px_14px_rgba(255,194,51,0.25)] hover:scale-[1.02] backdrop-blur-sm',
    ghost: 'text-gold-300 hover:bg-gold-900/50 hover:text-gold-200 hover:scale-[1.02] hover:shadow-[0_2px_8px_rgba(255,194,51,0.2)]',
  };
