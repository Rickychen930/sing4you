      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-jazz-900/60 via-gold-900/50 to-musical-900/60 px-4 sm:px-6 py-10 sm:py-12 lg:py-16 relative overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none opacity-[0.12] sm:opacity-10">
            ...
            <div className="absolute bottom-1/4 right-1/4 w-64 h-64 sm:w-96 sm:h-96 lg:w-[28rem] lg:h-[28rem] bg-musical-500/25 rounded-full blur-2xl animate-musical-pulse shadow-[0_0_60px_rgba(168,85,247,0.3)]" style={{ animationDelay: '1s' }}></div>
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-40 h-40 sm:w-56 sm:h-56 bg-gold-500/12 rounded-full blur-2xl animate-musical-pulse shadow-[0_0_40px_rgba(255,194,51,0.15)]" style={{ animationDelay: '0.5s' }} aria-hidden />
          </div>
          <div className="absolute inset-0 pointer-events-none opacity-[0.08] sm:opacity-[0.06]" aria-hidden>
            ...
            <span className="absolute bottom-10 right-10 text-3xl sm:text-4xl lg:text-5xl text-musical-400/30 font-musical animate-float" style={{ animationDelay: '1.5s' }}>♫</span>
          </div>
          ...
          <Card className="max-w-lg w-full relative z-10 hover">
            <CardHeader className="p-5 sm:p-6 lg:p-8 text-center">
              <div className="relative inline-block mb-4 sm:mb-5 lg:mb-6">
                ...
                <div className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl relative opacity-80 sm:opacity-70 animate-float" style={{ filter: 'drop-shadow(0 0 12px rgba(255,194,51,0.3))' }} aria-hidden>⚠️</div>
              </div>
              <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-elegant font-bold text-center bg-gradient-to-r from-gold-300 via-gold-200 to-gold-100 bg-clip-text text-transparent leading-tight px-4" style={{ textShadow: '0 2px 10px rgba(255, 194, 51, 0.2), 0 1px 4px rgba(168, 85, 247, 0.12)' }}>
                Oops! Something went wrong
              </h1>
            </CardHeader>
            <CardBody className="p-5 sm:p-6 lg:p-8">
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-200 mb-5 sm:mb-6 text-center font-light leading-relaxed" style={{ textShadow: '0 1px 3px rgba(0, 0, 0, 0.4)' }}>
