...
export const SocialShareButtons: React.FC<SocialShareButtonsProps> = memo(({
  url,
  title,
  description = '',
  className,
  ...
  const shareLinks = useMemo(() => ({
    ...
    twitter: `https://twitter.com/intent/tweet?url=${encodedUrl}&text=${encodedTitle}${description ? `&via=ChristinaSings4U` : ''}`,
    whatsapp: `https://wa.me/?text=${encodedTitle}%20${encodedUrl}`,
    email: `mailto:?subject=${encodedTitle}&body=${encodedDescription}%20${encodedUrl}`,
    linkedin: `https://www.linkedin.com/sharing/share-offsite/?url=${encodedUrl}`,
  }), [encodedUrl, encodedTitle, encodedDescription, description]);

  const handleShare = useCallback((platform: keyof typeof shareLinks, e: React.MouseEvent) => {
    e.preventDefault();
    ...
    >
      <button
        ...
        className={cn(
          ...
          'hover:scale-105 active:scale-95 shadow-[0_4px_12px_rgba(24,119,242,0.3)] hover:shadow-[0_6px_16px_rgba(24,119,242,0.4)]'
        )}
      ...
      <button
        ...
        className={cn(
          ...
          'hover:scale-105 active:scale-95 shadow-[0_4px_12px_rgba(29,161,242,0.3)] hover:shadow-[0_6px_16px_rgba(29,161,242,0.4)]'
        )}
      ...
      <button
        ...
        className={cn(
          ...
          'hover:scale-105 active:scale-95 shadow-[0_4px_12px_rgba(37,211,102,0.3)] hover:shadow-[0_6px_16px_rgba(37,211,102,0.4)]'
        )}
      ...
      <button
        ...
        className={cn(
          ...
          'hover:scale-105 active:scale-95 shadow-[0_4px_12px_rgba(255,194,51,0.3)] hover:shadow-[0_6px_16px_rgba(255,194,51,0.4)]'
        )}
      ...
      <button
        ...
        className={cn(
          ...
          'hover:scale-105 active:scale-95 shadow-[0_4px_12px_rgba(0,119,181,0.3)] hover:shadow-[0_6px_16px_rgba(0,119,181,0.4)]'
        )}
