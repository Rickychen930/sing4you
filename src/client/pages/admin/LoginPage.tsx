              ...
              <CardBody>
                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5 lg:space-y-6" noValidate>
                  ...
                  <p className="text-xs sm:text-sm text-center text-gray-400 mt-3 sm:mt-4">
                    Press <kbd className="px-1.5 sm:px-2 py-0.5 sm:py-1 bg-jazz-900/50 border border-gold-900/30 rounded text-gold-400 text-xs sm:text-sm">Enter</kbd> to login
                  </p>
                </form>
              </CardBody>
            </Card>
