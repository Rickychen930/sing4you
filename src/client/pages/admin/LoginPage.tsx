...
export const LoginPage: React.FC = () => {
  ...
  if (isCheckingAuth) {
    return (
      <>
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-jazz-900/60 via-gold-900/50 to-musical-900/60 px-4 py-8">
  ...
  return (
    <>
      <SEO title="Admin Login | Christina Sings4U" />
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-jazz-900/60 via-gold-900/50 to-musical-900/60 px-4 py-8 relative overflow-hidden">
        {/* Decorative background elements */}
        <div className="absolute inset-0 pointer-events-none opacity-10">
          <div className="absolute top-1/4 left-1/4 text-6xl text-gold-400 animate-float font-musical">♪</div>
          <div className="absolute bottom-1/4 right-1/4 text-5xl text-musical-400 animate-float font-musical" style={{ animationDelay: '2s' }}>♫</div>
        </div>
          ...
          <CardBody className="p-6 sm:p-8">
            <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6" noValidate>
              ...
              <p className="text-xs text-center text-gray-400 mt-4">
                Tekan <kbd className="px-2 py-1 bg-jazz-900/50 border border-gold-900/30 rounded text-gold-400">Enter</kbd> untuk login
              </p>
            </form>
          </CardBody>
        </Card>
