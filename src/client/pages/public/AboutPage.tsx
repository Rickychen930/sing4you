  ...
  return (
    <>
      ...
      <SectionWrapper id="about-hero" className="pt-8 sm:pt-10 lg:pt-12">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6">
          <div className="relative inline-block mb-5 sm:mb-6 lg:mb-8">
            ...
            <h1 className="relative text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-elegant font-bold mb-4 sm:mb-5 lg:mb-6 bg-gradient-to-r from-gold-300 via-gold-200 to-gold-100 bg-clip-text text-transparent leading-tight about-page-hero-title">
      ...
      <SectionWrapper id="about-services">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="relative inline-block mb-8 sm:mb-10 lg:mb-12 w-full text-center">
            ...
            <h2 className="relative text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-elegant font-bold mb-6 sm:mb-8 text-center bg-gradient-to-r from-gold-300 via-gold-200 to-gold-100 bg-clip-text text-transparent leading-tight about-page-section-title">
              What I Offer
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-7 lg:gap-8 xl:gap-10">
            <Card hover className="animate-fade-in-up about-page-service-item" style={{ '--animation-delay': '0ms' } as React.CSSProperties}>
              <CardBody large className="relative">
                {/* Enhanced musical note decoration */}
                <div className="absolute top-3 right-3 text-xl sm:text-2xl lg:text-3xl text-gold-500/30 group-hover:text-gold-400/70 transition-all duration-300 animate-float font-musical pointer-events-none z-20 about-page-musical-1" aria-hidden>♪</div>
                ...
                <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-200 leading-relaxed font-sans group-hover:text-gray-100 transition-colors duration-300 about-page-service-text">
                  Intimate and powerful solo performances perfect for smaller events and ceremonies.
                </p>
              </CardBody>
            </Card>
            <Card hover className="animate-fade-in-up about-page-service-item" style={{ '--animation-delay': '100ms' } as React.CSSProperties}>
              <CardBody large className="relative">
                <div className="absolute top-3 right-3 text-xl sm:text-2xl lg:text-3xl text-musical-500/30 group-hover:text-musical-400/60 transition-all duration-300 animate-float font-musical pointer-events-none z-20 about-page-musical-2" aria-hidden>♫</div>
            ...
            <Card hover className="animate-fade-in-up about-page-service-item" style={{ '--animation-delay': '200ms' } as React.CSSProperties}>
              <CardBody large className="relative">
                <div className="absolute top-3 right-3 text-xl sm:text-2xl lg:text-3xl text-gold-500/30 group-hover:text-gold-400/70 transition-all duration-300 animate-float font-musical pointer-events-none z-20 about-page-musical-3" aria-hidden>♬</div>
            ...
            <Card hover className="animate-fade-in-up about-page-service-item" style={{ '--animation-delay': '300ms' } as React.CSSProperties}>
              <CardBody large className="relative">
                <div className="absolute top-3 right-3 text-xl sm:text-2xl lg:text-3xl text-musical-500/30 group-hover:text-musical-400/60 transition-all duration-300 animate-float font-musical pointer-events-none z-20 about-page-musical-4" aria-hidden>♩</div>
      ...
      <SectionWrapper id="about-cta">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6">
          <div className="relative inline-block mb-5 sm:mb-6 lg:mb-8">
            <h2 className="relative text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl font-elegant font-bold mb-4 sm:mb-5 lg:mb-6 xl:mb-8 bg-gradient-to-r from-gold-300 via-gold-200 to-gold-100 bg-clip-text text-transparent leading-tight px-4 about-page-section-title">
