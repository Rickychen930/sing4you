    ...
    <Layout>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-jazz-900/60 via-gold-900/50 to-musical-900/60 px-4 sm:px-6 py-10 sm:py-12 lg:py-16 relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none opacity-10">
          ...
          <div className="absolute bottom-1/4 right-1/4 text-4xl sm:text-6xl lg:text-8xl text-musical-400/60 animate-float font-musical" style={{ animationDelay: '2s' }}>♫</div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-3xl sm:text-5xl lg:text-7xl text-gold-400/40 animate-float font-musical" style={{ animationDelay: '4s' }}>♬</div>
        </div>
        ...
        <div className="max-w-lg w-full text-center relative z-10 px-4">
          <div className="mb-6 sm:mb-8 lg:mb-10 relative inline-block">
            ...
            <h1 className="relative text-6xl sm:text-8xl md:text-9xl lg:text-[10rem] xl:text-[12rem] 2xl:text-[14rem] font-elegant font-bold bg-gradient-to-r from-gold-500 via-gold-400 to-musical-500 bg-clip-text text-transparent mb-3 sm:mb-4 drop-shadow-2xl leading-none" style={{ textShadow: '0 0 60px rgba(255, 194, 51, 0.4), 0 0 120px rgba(168, 85, 247, 0.3)' }}>
              404
            </h1>
          </div>
          <div className="relative inline-block mb-5 sm:mb-6 lg:mb-8">
            ...
            <h2 className="relative text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-elegant font-bold mb-3 sm:mb-4 lg:mb-6 bg-gradient-to-r from-gold-300 via-gold-200 to-musical-300 bg-clip-text text-transparent leading-tight px-4" style={{ textShadow: '0 0 40px rgba(255, 194, 51, 0.3), 0 0 80px rgba(168, 85, 247, 0.2)' }}>
              Page Not Found
            </h2>
          </div>
